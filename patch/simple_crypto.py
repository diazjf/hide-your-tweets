# This is a patch for devstack to recognize the simple crypto plugin.
# Please see https://bugs.launchpad.net/barbican/+bug/1602936
...
class SimpleCryptoPlugin(c.CryptoPluginBase):
    ...
    def generate_asymmetric(self, generate_dto, kek_meta_dto, project_id):
        ...
        if(generate_dto.algorithm is None or generate_dto
            ...
            private_key = Crypto.PublicKey.DSA.generate(generate_dto.bit_length, None, None)
        else:
